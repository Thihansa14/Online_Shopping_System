...
public class Validation {
    ...
    public static int integer(String promt) {
        while (true) {
            try {
    ...
    public static double Double(String promt) {
        while (true) {
            try {
                System.out.print(promt);
    ...
    public static String stringValidation(String promt){
        String regex = "^[a-zA-Z]+$";
    ...
    public static String sizeValidation(String prompt) {
        ...
        while (true) {
            ...
            System.out.println("Invalid cloth size! Please enter a valid size (XS, S, M, L, XL, XXL, XXXL).");
        }
    }
